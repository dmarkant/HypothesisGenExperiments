/*
Main task code for Experiment 1.
*/

// 1D rules may be referred to throughout as rule-based (rb),
// while 2D rules may be referred to as information-integration (ii)
...
// mapping of physical dimensions (left-right, up-down mouse
// movements) to stimulus dimensions is randomized
...
// Circle+spoke stimuli referred to here as 'antennae'
...
var Stimulus = function(args) {
	...
	// where to go after done with this stimulus
